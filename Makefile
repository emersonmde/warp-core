...
.PHONY: test_compress test_decompress test_poly_addsub test_cbd_sampler
...
.PHONY: waves_compress waves_decompress waves_poly_addsub waves_cbd_sampler
...
test: test_cond_sub_q test_barrett_reduce test_cond_add_q test_mod_add test_mod_sub test_ntt_butterfly \
      ...
      test_compress test_decompress test_poly_addsub test_cbd_sampler
